  ...
  <tr>
    <td style="background:#f8fafc;padding:20px 40px;text-align:center;border-top:1px solid #e2e8f0;">
      <p style="margin:0;font-size:11px;color:#94a3b8;">
        Sent by <strong>${d.businessName}</strong> via Raphael Samuel Soutien · Appointment ID: <code style="font-size:10px;">${d.appointmentId}</code>
      </p>
    </td>
  </tr>
</table>
...
<table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.07);">
  <tr><td style="background:linear-gradient(135deg,#0a3d40,#0d7377);padding:24px 32px;">
    ...
    <p style="margin:4px 0 0;font-size:12px;color:rgba(255,255,255,0.6);">${d.businessName} — Raphael Samuel Soutien</p>
  </td></tr>
